...
@section('content')
                ...
                @if($data && $data->count())
                    ...
                    @foreach($data as $abk)
                        <tr>
                            ...
                            <td>{{ $abk->jabatan }}</td>
                            <td>
                                <span class="{{ $abk->status === 'active' ? 'text-success' : 'text-danger' }}">
                                    {{ ucfirst($abk->status) }}
                                </span>
                            </td>
    ...
    <div class="modal fade" id="createModal" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog">
            <form class="modal-content" method="post" action="{{ route('lainnya.abk.store') }}">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            ...
                            <option value="nonactive">{{ __('Nonactive') }}</option>
                        </select>
                    </div>
                </div>
